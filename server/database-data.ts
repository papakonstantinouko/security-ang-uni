export const LESSONS = {
  1: {
    ...
    longDescription:
      '<p>This is step by step guide to create your first  application. <b>Its aimed at beginners</b> just starting out with the framework.This lesson will show how to create a component, and how to link the component to a given custom HTML tag. It will show how to give the component a given template.</p>',
    tags: 'BEGINNER',
    duration: '4:17',
  ...
  2: {
    ...
    duration: '2:07',
    longDescription:
      '<p>In this lesson we are going to see how to include a component inside another component. We are going to create a simple search box component and include it in our main application.</p>',
    tags: 'BEGINNER',
  ...
  3: {
    ...
    duration: '2:33',
    longDescription:
      '<p>In this lesson we are going to learn how to use the  template syntax for properties, and learn how we can use it to pass input data to a component. We are going to see also a simplified input syntax for passing constant strings as component inputs.</p>',
    tags: 'BEGINNER',
  ...
  6: {
    ...
    duration: '3:27',
    longDescription:
      '<p>In this lesson we are going to learn how components can be styled using both inline styles and an external css file. We will learn some more best practices on file naming. We will learn how the mechanism for style isolation works in.</p>',
    tags: 'BEGINNER',
  ...
  7: {
    ...
    duration: '9:22',
    longDescription:
      '<p>In this lesson we are going to put together all that we have learned so far about components to create a more complex example. We are going to create two components: a color picker and a color previewer and see how they can interact.</p>',
    tags: 'BEGINNER',
  ...
  8: {
    ...
    duration: '1:26',
    longDescription:
      '<p>In this video we are going to present an exercise for putting in practice the several concepts that we have learned so far about components.</p>',
    tags: 'BEGINNER',
  ...
  9: {
    ...
    duration: '2:08',
    longDescription:
      '<p>This video contains the solution for the introduction to components exercise.</p>',
    tags: 'BEGINNER',
